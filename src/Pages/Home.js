...
// Home Page, including the Quote component for returning the Quote of the day:

return (
    <div className="mx-4">
        <h2>Welcome to your personal organizer! Today's date is: {new Date().toLocaleString("en-US", { month: "long" })} {new Date().toLocaleString("en-US", { day : '2-digit'})} {new Date().getFullYear()}</h2>
    <div id='hmm'>
...
/*
Hello. Welcome to your personal organizer. Today's date is...
